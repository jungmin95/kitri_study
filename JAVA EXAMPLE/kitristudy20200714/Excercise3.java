...
public class Excercise3 {
	static int getGroupCount(TreeSet tset, int from, int to) {
		Student1 s1 = new Student1("from", 0, 0, from, from, from);
		Student1 s2 = new Student1("to", 0, 0, to, to, to);
