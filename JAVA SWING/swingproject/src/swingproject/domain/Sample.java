...
public class Sample {
	...
	public static Vector<Member> getMembers(){
		...
		members.add(new Member(6,"ssarmango","bitc5600","jooho","ssar@nate.com", "01022228888"));
		members.add(new Member(7,"ssarmango","bitc5600","jooho","ssar@nate.com", "01022228888"));
		members.add(new Member(8, "ssarmango","bitc5600","jooho","ssar@nate.com", "01022228888"));
